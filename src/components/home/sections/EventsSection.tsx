...
import { VerticalInfiniteCarousel } from "@/components/ui/VerticalInfiniteCarousel";
  ...
  useEffect(() => {
    const fetchEvents = async () => {
      try {
        setLoading(true);
        setError(null);
        const upcomingEvents = await eventService.getUpcomingEvents(9);
